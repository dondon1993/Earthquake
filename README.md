...
In this [competition](https://www.kaggle.com/c/LANL-Earthquake-Prediction), you will address when the earthquake will take place. Specifically, you’ll predict the time remaining before laboratory earthquakes occur from real-time seismic data.
